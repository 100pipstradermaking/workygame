...
class LoadingScreen:
    ...
    def draw(self):
        ...
        sub_surf = pygame.Surface((self.sw, 30), pygame.SRCALPHA)
        sub_text = self.font_md.render(
            "Burger Economy Simulator", True, (*TEXT_GRAY[:3], sub_alpha))
        sub_rect = sub_text.get_rect(center=(cx, 15))
        sub_surf.blit(sub_text, sub_rect)
        self.screen.blit(sub_surf, (0, 170))
        ...
        tip_surf = self.font_sm.render(f"TIP: {tip}", True, TEXT_GRAY)
